...
const String sheet_url = "https://script.google.com/macros/s/AKfycbx_CeesLfsuot1lfJplNGL-3fyPTnn8Dbf7nYEYl6LSK8zNmtFYzwhhbZoYioYXNeo_/exec?name=";
//-----------------------------------------
// Fingerprint for demo URL, expires on ‎Monday, ‎May ‎2, ‎2022 7:20:58 AM, needs to be updated well before this date
const uint8_t fingerprint[20] = {0x38, 0x70, 0x9a, 0x18, 0xf6, 0x8d, 0xb1, 0xca, 0x22, 0xde, 0x2b, 0x9d, 0xa6, 0xaf, 0x36, 0x68, 0xbf, 0x32, 0x6a, 0xc7};
//9a 87 9b 82 e9 19 7e 63 8a db 67 ed a7 09 d9 2f 30 de e7 3c
//-----------------------------------------
#define WIFI_SSID "Larry_Wifi"
#define WIFI_PASSWORD "larrY1234"
//-----------------------------------------
